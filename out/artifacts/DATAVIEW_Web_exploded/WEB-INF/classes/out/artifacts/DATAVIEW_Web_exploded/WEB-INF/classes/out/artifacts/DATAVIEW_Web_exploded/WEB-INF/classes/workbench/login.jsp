...
<head>
    ...
    <script src="./Web_Files/main.js"></script>
    <script type="text/javascript">_W.configDomain = "www.weebly.com";</script>
    <script type="text/javascript" src="./Web_Files/ftl.js"></script>
    ...
    (function (jQuery) {
        function initFlyouts() {
            initPublishedFlyoutMenus(
                [{
                    "id": "683068889534902185",
                    "title": "Home",
                    "url": "index.html",
                    "target": ""
                }, {
                    "id": "889730839970818043",
                    "title": "Projects",
                    "url": "projects.html",
                    "target": ""
                }, {
                    "id": "437858188312795895",
                    "title": "Publications",
                    "url": "http:\/\/www.cs.wayne.edu\/~shiyong\/pubs.htm",
                    "target": "_blank"
                }, {
                    "id": "469551346302134232",
                    "title": "Alumni",
                    "url": "alumni.html",
                    "target": ""
                }, {
                    "id": "389786541452826855",
                    "title": "Wiki",
                    "url": "https:\/\/sites.google.com\/site\/swfwikicopy\/",
                    "target": "_blank"
                }, {
                    "id": "161242430389340639",
                    "title": "Contact",
                    "url": "contact.html",
                    "target": ""
                }, {"id": "995752295821370213", "title": "New Page", "url": "new-page.html", "target": ""}],
                "995752295821370213",
                '',
                'active',
                false,
...
<form id="frmMain" method="post" action="UserLogin" onsubmit="return validateForm()">
            ...
            <div id="header-container">
                    ...
                    <tr>
                        <td id="logo">
                            <span class="wsite-logo">
                                <a href="http://www.cs.wayne.edu/"><img src="./Web_Files/dataviewlogo.png"></a>
                            </span>
                        </td>
                        <td id="header-right">
                            <table>
                ...
                <div id="topnav">
                    <ul class="wsite-menu-default">
                        ...
                        <li id="pg889730839970818043" class="wsite-menu-item-wrap   wsite-nav-2"
                            style="position: relative;">
                            <a href="http://bigdataworkflow.weebly.com/projects.html" class="wsite-menu-item"
                               style="position: relative;">
                                Projects
                            </a>
                        </li>
                        <li id="pg437858188312795895" class="wsite-menu-item-wrap   wsite-nav-3"
                            style="position: relative;">
                            <a href="http://www.cs.wayne.edu/~shiyong/pubs.htm" target="_blank" class="wsite-menu-item"
                               style="position: relative;">
                                Publications
                            </a>
                        </li>
                        <li id="pg469551346302134232" class="wsite-menu-item-wrap   wsite-nav-4"
                            style="position: relative;">
                            <a href="http://bigdataworkflow.weebly.com/alumni.html" class="wsite-menu-item"
                               style="position: relative;">
                                Alumni
                            </a>
                        </li>
                        <li id="pg389786541452826855" class="wsite-menu-item-wrap   wsite-nav-5"
                            style="position: relative;">
                            <a href="https://sites.google.com/site/swfwikicopy/" target="_blank" class="wsite-menu-item"
                               style="position: relative;">
                                Wiki
                            </a>
                        </li>
                        <li id="pg161242430389340639" class="wsite-menu-item-wrap   wsite-nav-6"
                            style="position: relative;">
                            <a href="http://bigdataworkflow.weebly.com/contact.html" class="wsite-menu-item"
                               style="position: relative;">
                                Contact
                            </a>
                        </li>
                        <li id="pg161242430389340640" class="wsite-menu-item-wrap   wsite-nav-6"
                            style="position: relative;">
                            <a  href="/toNewWorkbench" class="wsite-menu-item new-workflow"
                               style="position: relative;">
                                new workflow panel
                            </a>
                        </li>
                                    ...
                                    <table class="wsite-multicol-table">
                                        ...
                                        <tr class="wsite-multicol-tr">
                                            <td class="wsite-multicol-col" style="width:50%; padding:0 15px;">
                                                <h2 class="wsite-content-title" style="text-align:left;">DATAVIEW - from
                                                    data, to insight, to value<br><br><font color="#a1a1a1" size="3">"Deposit,
                                                        access, analyze, visualize, and share your data ... All in the
                                                        Cloud."</font><br><br><br></h2>
                                            </td>
                                            <td class="wsite-multicol-col" style="width:50%; padding:0 15px;">
                                                <div>
                                                    <div id="533165323902803737" align="left"
                                                         style="width: 100%; overflow-y: hidden;" class="wcustomhtml">
                                                        <table cellpadding="2px" cellspacing="1px" bgcolor="#F4F5F7"
                                                               width="400px" class="tableBorder" align="right">
                                                            <tbody>
                                                            <tr>
                                                                <!--
                                         <td colspan="2" bgcolor="#0066FF">&nbsp;</td>
                                                            ...
                                                            <tr>
                                                                <th align="left" colspan="2"><font size="1">Don't have
                                                                    an account? <a href="#" onclick="showDialog()" ;
                                                                                   return false;> Sign up for free </a></font>
                                                                </th>
                                                            </tr>
                                                            <tr>
                                                                <th align="left" colspan="2"><font size="1"><a
                                                                        href="forgotPassword.jsp">Forgot
                                                                    password?</a></font></th>
                                                            </tr>
    ...
    <div id="footer-wrap">
        <div id="page">
            <div id="footer">
                ...
                <div id="weebly-footer-signup-container" class="light"
                     style="height: 58px; position: relative; left: -259.461px; top: 45.5937px; width: 1419px;">
                    <div class="signup-container-header">
                        <div class="start-free">Create a <a class="link"
                                                            href="http://www.weebly.com/?utm_source=internal&utm_medium=footer&utm_campaign=3"
                                                            target="_blank">free website</a></div>
                        <div class="expand-icon"></div>
                        <div class="powered-by"><span>Powered by</span> <a class="link weebly-icon"
                                                                           href="http://www.weebly.com/?utm_source=internal&utm_medium=footer&utm_campaign=3"
                    ...
                    <div class="signup-container-content">
                        ...
                        <div class="description">A surprisingly easy drag &amp; drop site creator. <a
                                class="thin-underline"
                                href="http://www.weebly.com/?utm_source=internal&utm_medium=footer&utm_campaign=3"
                                target="_blank" rel="nofollow">Learn more.</a></div>
                        <iframe id="weebly-footer-signup-iframe" frameborder="0" src="./Web_Files/footer_signup.html"
    ...
    <noscript>
        ...
        &lt;img src="//pixel.quantserve.com/pixel/p-0dYLvhSGGqUWo.gif?labels=l0,u51275705.u51275705s632811976679423967"
...
<div id="dialog-1" title="Sign up for DATAVIEW">
    <form id="signupForm" accept-charset="utf-8" action="UserReg"
                ...
                <div>
                    <div class="wsite-form-field" style="margin: 5px 0px 5px 0px;">
                        ...
                        <div class="wsite-form-input-container">
                            <input
                                    class="wsite-form-input wsite-input wsite-input-width-370px"
                                    type="text" name="input-organization" size="35" id="input-organization"
                                    required=""/>
                        </div>
                    </div>
                </div>
                ...
                <div>
                    <div class="wsite-form-field" style="margin: 5px 0px 5px 0px;">
                        ...
                        <div class="wsite-form-input-container">
                            <input
                                    class="wsite-form-input wsite-input wsite-input-width-370px"
                                    name="input-repeat-password" id="input-repeat-password" type="password"
                                    required=""/>
                        </div>
                    </div>
                </div>
        ...
        <br>
        <button class='wsite-button' style="border:0px;" type="submit"><span class='wsite-button-inner'>Sign up</span>
        </button>
        <button class='wsite-button' style="border:0px;" type="Cancel"
                onClick="$('#dialog-1').dialog( 'close' );return false"><span class='wsite-button-inner'>Cancel</span>
        </button>
    </form>
</div>
...
<script>
    /**
     *  create by bohan
     *  use for redirect to vue.js workflow
     */
    // $('.new-workflow').on("click", function (event){
