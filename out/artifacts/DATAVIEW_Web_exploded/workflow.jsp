...
<head>
    ...
    <script type="text/javascript">
        ...
        function createCustomDialogWindow(cellContent) {
            ...
            //if it's a port:
            if (result.indexOf("inputPort.png") != -1 || result.indexOf("outputPort.png") != -1) {
                var portHTML = result;
...
<div id="DropboxDiv" style="overflow:'hidden';display:none;">
    ...
    <p>Hint: First-time user please refer to the following steps to start:<br>
        ...
        Step 2. Create your Dropbox App <a
                href="http://www.dropbox.com/login?cont=https%3A%2F%2Fwww.dropbox.com%2Fdevelopers%2Fapps%2Fcreate"
                target="_blank">Here</a>.<br>
        Step 3. After creating the app, record the App Key, App Secret and Access Token generated, and fill them into
        the above textboxes.<br>
